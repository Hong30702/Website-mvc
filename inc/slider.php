<div class="header_bottom">
		<div class="header_bottom_left">
			<div class="section group">
				...
				<div class="listview_1_of_2 images_1_of_2">
					<div class="listimg listimg_2_of_1">
						 <a href="#"> <img src="admin/uploads/<?php echo $resultiphone['image'] ?>" alt="" /></a>
					</div>
			   ...
			   ?>	
				...
				<div class="listview_1_of_2 images_1_of_2">
					<div class="listimg listimg_2_of_1">
						  <a href="#"><img src="admin/uploads/<?php echo $resultipad['image'] ?>" alt="" /></a>
					</div>
					<div class="text list_2_of_1">
						  <h2>iPad</h2>
			...
			<div class="section group">
				...
				<div class="listview_1_of_2 images_1_of_2">
					<div class="listimg listimg_2_of_1">
						 <a href="#"> <img src="admin/uploads/<?php echo $resultmacbook['image'] ?>" alt="" /></a>
					</div>
				    <div class="text list_2_of_1">
						<h2>MacBook</h2>
			   ...
			   <?php
				...
				<div class="listview_1_of_2 images_1_of_2">
					<div class="listimg listimg_2_of_1">
						  <a href="#"><img src="admin/uploads/<?php echo $resultairpods['image'] ?>" alt="" /></a>
					</div>
					<div class="text list_2_of_1">
						  <h2>AirPods</h2>
